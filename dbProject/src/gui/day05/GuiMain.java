...
public class GuiMain extends JFrame implements ActionListener  {
	...
	private void init() {
		...
		// 버튼에게 actionListener 가 어디에 있는지 알려주기
		...
		this.setLayout(null);
		this.setSize(500,350);			// 윈도의 크기
		this.setResizable(false);		// 윈도의 크기 조절 하기
